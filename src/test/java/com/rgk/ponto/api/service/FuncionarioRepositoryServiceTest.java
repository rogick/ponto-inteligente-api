...
@SpringBootTest
@ActiveProfiles("test")
public class FuncionarioRepositoryServiceTest {
	
	private static final String CPF = "123456789-89";
	...
	public void testBuscarFuncionarioPorEmail() {
		Optional<Funcionario> funcionario = this.funcionarioService.buscarPorCpf(EMAIL);
